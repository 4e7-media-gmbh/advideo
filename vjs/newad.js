            ...
            requestAds = function () {
                ...
                fetch("https://ad1.adfarm1.adition.com/banner?sid=3123832&ts=3208062&wpt=X&prf[consent]=optin")
                    ...
                    .then(function (data) {
                        ...
                        var adTagz = xmlDoc.getElementsByTagName("MediaFile")
                        var advideo = adTagz.item(0).innerHTML.replace("<![CDATA[", "").replace("]]>", "");
                        var adclick = xmlDoc.getElementsByTagName("ClickThrough");
                        var click = adclick.item(0).innerHTML.replace("<![CDATA[", "").replace("]]>", "")
                        ad.push(advideo, click)
                    })
                // fetch ad inventory
