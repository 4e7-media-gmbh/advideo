(function e(t, n, r) {
    ...
    var IVPAIDAdUnit = exports.IVPAIDAdUnit = function () {
      ...
      _createClass(IVPAIDAdUnit, [{
        ...
        value: function initAd(width, height, viewMode, desiredBitrate) {
          var creativeData = arguments.length <= 4 || arguments[4] === undefined ? {
            AdParameters: ''
          } : arguments[4];
          var environmentVars = arguments.length <= 5 || arguments[5] === undefined ? {
            flashVars: ''
          } : arguments[5];
  ...
  3: [function (require, module, exports) {
    ...
    var VPAIDFLASHClient = function () {
      function VPAIDFLASHClient(vpaidParentEl, callback) {
        var swfConfig = arguments.length <= 2 || arguments[2] === undefined ? {
          data: 'VPAIDFlash.swf',
          width: 800,
          height: 400
        } : arguments[2];
        ...
        var vpaidOptions = arguments.length <= 4 || arguments[4] === undefined ? {
          debug: false,
          timeout: 10000
        } : arguments[4];
  ...
  4: [function (require, module, exports) {
    ...
    var FlashTester = function () {
      function FlashTester(parent) {
        ...
        var swfConfig = arguments.length <= 1 || arguments[1] === undefined ? {
          data: 'VPAIDFlash.swf',
          width: 800,
          height: 400
        } : arguments[1];
  ...
  22: [function (require, module, exports) {
    ...
    VASTClient.prototype._trackError = function (error, adChain) {
      ...
      vastUtil.track(errorURLMacros, {
        ERRORCODE: error.code || 900
      }); //900 <== Undefined error
  ...
  24: [function (require, module, exports) {
    ...
    VASTIntegrator.prototype._trackError = function trackError(error, response) {
      vastUtil.track(response.errorURLMacros, {
        ERRORCODE: error.code || 900
      });
    };
  ...
  26: [function (require, module, exports) {
    ...
    VASTTracker.prototype.initialize = function (assetURI, vastResponse) {
      ...
      this.quartiles = {
        firstQuartile: {
          tracked: false,
          time: Math.round(25 * vastResponse.duration) / 100
        },
        midpoint: {
          tracked: false,
          time: Math.round(50 * vastResponse.duration) / 100
        },
        thirdQuartile: {
          tracked: false,
          time: Math.round(75 * vastResponse.duration) / 100
        }
      };
    };
  ...
  30: [function (require, module, exports) {
    ...
    var vastUtil = {
      ...
      runFlashSupportCheck: function runFlashSupportCheck(vpaidFlashLoaderPath) {
        VPAIDFLASHClient.runFlashTest({
          data: vpaidFlashLoaderPath
        });
      }
  ...
  32: [function (require, module, exports) {
    ...
    VPAIDFlashTech.prototype.loadAdUnit = function loadFlashCreative(containerEl, objectEl, callback) {
      var that = this;
      var flashClientOpts = this.settings && this.settings.vpaidFlashLoaderPath ? {
  ...
  34: [function (require, module, exports) {
    ...
    VPAIDIntegrator.prototype._createVPAIDAdUnitWrapper = function (adUnit, src, responseTimeout) {
      return new VPAIDAdUnitWrapper(adUnit, {
        src: src,
    ...
    VPAIDIntegrator.prototype._initAd = function (adUnit, vastResponse, next) {
      ...
      adUnit.initAd(dimension.width, dimension.height, this.VIEW_MODE.NORMAL, -1, {
